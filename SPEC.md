...
| id             | 文案方向                   | 效果（Phase 3）          |
| -------------- | -------------------------- | ------------------------ |
| `snack_boom`   | 天王巨星代言薯片，全城瘋搶 | 薯片 multiplier = 2.5    |
| `crypto_crash` | 區塊鏈泡沫爆破，交易所跑路 | 比特幣 multiplier = 0.35 |
| `windfall`     | 行街踩中六合彩             | 現金 + $50,000           |
| `collapse`     | 打兩份工兼炒幣，暈倒街頭   | 健康 -20、現金 -$12,000  |
