...
- 價格隨機區間：`0.62–1.55`（炒貨同創業都要可贏，唔係單一最優）。
- 平淡事件權重提高；極端炒價／現金大獎幅度下調。
- 公司淨年回報約 15–22%（由 ~35–45% 下調）；估值約 1.35–1.5× 投資額；倒閉率略升。
- 創業開業 IPO：當刻市值 = 投資額，唔可以即刻賣盤賺差價；股價年結先按估值浮動。
- 股價年結 roll：`0.82–1.28`；倉庫升級 base `$45k`、growth `1.75`。
- 電動車佔 2 倉庫格，令高階梭哈要付出倉位代價。
- 可玩性補強：負面現金事件封頂（最多 50% 現金、保留 $1,000）、健康年耗 4、五年免費檢查、醫生費 wealth cap、第一次創業保底成功、失敗退一半籌備費。
- 標題頁可選「簡易模式」（健康消耗減半、負面現金事件再半）。
- UX：市場合約價格訊號、快捷數量、結束回合僅危險時 confirm、年結摘要 modal、資產／人生里程碑 toast。
- 模擬目標：總勝率約 5–25%；trade / company / hybrid 各有 ≥$10M 局；冇單一策略每 seed 必勝。
