        ...
        >
            {partner && PartnerIcon ? (
                <div className="mb-3 rounded-2xl border-2 border-(--border) bg-[#ffe8e4] p-3">
                    ...
                    <p className="mt-2 text-[11px] font-bold leading-snug text-(--muted)">
                    ...
                    {state.children.length > 0 ? (
                        ...
                        <p className="mt-2 text-[11px] font-bold text-(--muted)">未有子女。每年有機會添丁。</p>
                    )}
                </div>
            ) : (
                <>
                                ...
                                <li key={person.id} className="rounded-2xl border-2 border-(--border) bg-[#fff8f6] p-3">
                                    <div className="mb-2 flex items-start gap-3">
                                        ...
                                        <div className="min-w-0 flex-1">
                                            ...
                                            <p className="text-sm font-black tabular-nums">婚禮 {formatMoney(person.weddingCost)}</p>
